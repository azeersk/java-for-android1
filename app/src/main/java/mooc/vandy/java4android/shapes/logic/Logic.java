...
public class Logic
    ...
    public static double boxVolume(double length, double width, double depth) {
        double azeer = length * width * depth;
        return azeer;
    }

    public static double boxSurfaceArea(double length, double width, double depth) {
        double azeer = 2* (length * width + width * depth + length * depth);
        return azeer;
    }

    public static double rectanglePerimeter(double length, double width) {
        double azeer = 2* (length + width);
        return azeer;
    }

    public static double rectangleArea(double length, double width) {
        double azeer = length * width;
        return azeer;
    }

    public static double sphereVolume(double radius) {
        double azeer = (4.0/3.0) * Math.PI * Math.pow(radius, 3);
        return azeer;
    }

    public static double sphereSurfaceArea(double radius) {
        double azeer = 4 * Math.PI * radius * radius;
        return azeer;
    }

    public static double circleCircumference(double radius) {
        double azeer = 2 * Math.PI * radius;
        return azeer;
    }

    public static double circleArea(double radius) {
        double azeer = Math.PI * radius * radius;
        return azeer;
    }

    public static double rightTrianglePerimeter(double base, double height) {
        double azeer = base + height + Math.sqrt(base * base + height * height);
        return azeer;
    }

    public static double rightTriangleArea(double base, double height) {
        double azeer = base * height / 2;
        return azeer;
    }
